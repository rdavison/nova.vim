...
call s:HL("Search"         , s:foreground    , s:yellow        , '')
...
call s:HL("Todo"           , s:background    , s:inconspicuous , s:none)
...
call s:HL("ocamlModule"      , s:purple        , ''          , s:none)
call s:HL("ocamlType"        , s:orange        , ''          , s:none)
call s:HL("ocamlConstructor" , s:purple        , ''          , s:none)
call s:HL("ocamlUnit"        , s:orange        , ''          , s:none)

call s:HL("terraComment"           , s:inconspicuous , ''  , s:none)
call s:HL("terraBrackets"          , s:deep_purple   , ''  , s:none)
call s:HL("terraProvider"          , s:orange        , ''  , s:none)
call s:HL("terraBraces"            , s:foreground    , ''  , s:none)
call s:HL("terraProviderName"      , s:foreground    , ''  , s:none)
call s:HL("terraResource"          , s:orange        , ''  , s:none)
call s:HL("terraResourceName"      , s:foreground    , ''  , s:none)
call s:HL("terraResourceTypeBI"    , s:foreground    , ''  , s:none)
call s:HL("terraResourceTypeStr"   , s:foreground    , ''  , s:none)
call s:HL("terraData"              , s:orange        , ''  , s:none)
call s:HL("terraDataName"          , s:foreground    , ''  , s:none)
call s:HL("terraDataTypeBI"        , s:foreground    , ''  , s:none)
call s:HL("terraDataTypeStr"       , s:foreground    , ''  , s:none)
call s:HL("terraSection"           , s:orange        , ''  , s:none)
call s:HL("terraStringInterp"      , s:deep_purple   , ''  , s:none)
call s:HL("terraValueBool"         , s:blue          , ''  , s:none)
call s:HL("terraValueDec"          , s:blue          , ''  , s:none)
call s:HL("terraValueHexaDec"      , s:blue          , ''  , s:none)
call s:HL("terraValueString"       , s:foreground    , ''  , s:none)
call s:HL("terraHereDocText"       , s:foreground    , ''  , s:none)
call s:HL("terraProvisioner"       , s:orange        , ''  , s:none)
call s:HL("terraProvisionerName"   , s:foreground    , ''  , s:none)
call s:HL("terraModule"            , s:orange        , ''  , s:none)
call s:HL("terraModuleName"        , s:foreground    , ''  , s:none)
call s:HL("terraValueFunction"     , s:deep_purple   , ''  , s:none)
call s:HL("terraValueVarSubscript" , s:deep_purple   , ''  , s:none)
